...
<FORM name="form_edit" action="mz_register_cont.php" method="post" enctype="application/x-www-form-urlencoded">
	$w_ref_tag
    <table width="98%" align="center" bgcolor="#D7E3F4" cellpadding="3" style="font-size: 12px;margin-top:-1em;">
   <tbody>
	<tr>
	<TD colspan=4>
		<div style="background-color: #2E2ECA;  color : #ffffff; font-size : 12px; padding:2px; text-align:center;">Edit Membership: Please edit information below then [save] or select [delete] to delete the  record.</div>
	<hr>
	</TD>
	</tr>
	...
	<TD colspan=4 align="center">
		<INPUT class="mz_b_menu_sm_l" type="button" value="Save Membership" name="Save" onclick="javascript:mz_save_record()">
		&nbsp;&nbsp;&nbsp;
		<!--INPUT class="mz_b_menu_sm_l" type="button" value="Suspend Membership" name="suspend" onclick="javascript:mz_change_member_status(2)">	
		&nbsp;&nbsp;&nbsp;
		...
		&nbsp;&nbsp;&nbsp; -->
		<INPUT class="mz_b_menu_sm_l" type="button" value="Delete Membership" name="delete_record" onclick="javascript:mz_change_member_status(6)">
	</td>
	</tr>
	<tr><TD colspan=4>
