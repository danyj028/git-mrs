...
class mz_menu_01
{
	...
	$bx="<input class=\"mz_x\" id=\"b1x\" type=\"button\" value=\"X\" style=\"color:#aa00aa;padding:1px\" onclick=\"mz_do_menu(1)\"></input>";
 ...
 $mz_menu_sys_b1 = $bx.$b11.$b12.$b13.$b14;
 ...
 $mz_menu_sys_b2 = $bx.$b21.$b22.$b23.$b24.$b25.$b26;
 
 echo $mz_menu_sys_b2; break();
